    ...
    <div class="app-sidebar sidebar-shadow" @mouseover="toggleSidebarHover('add','closed-sidebar-open')" @mouseleave="toggleSidebarHover('remove','closed-sidebar-open')">
        ...
        <div class="app-sidebar-content">
            <VuePerfectScrollbar class="app-sidebar-scroll" v-once>
                <sidebar-menu showOneChild :menu="accessMenu"/>
            </VuePerfectScrollbar>
        </div>
        ...
        data() {
            return {
                ...
                menu: [
                    {
                        title: 'Main',
                        icon: 'pe-7s-pen bg-premium-dark icon-gradient',
                        href: '/',
                        user_types: [ 1, 0 ]
                    },
                    // {
                    ...
                    // {
                    //     title: 'People',
                    //     icon: 'pe-7s-users bg-premium-dark icon-gradient',
                    //     href: '/people',
                    //     user_types: [ 0 ]
                    // },
                    {
                        title: 'Statistics',
                        icon: 'pe-7s-graph bg-premium-dark icon-gradient',
                        href: '/statistics',
                        user_types: [ 1, 0 ]
                    },
                    // {
                    //     title: 'Profile',
                    //     icon: 'pe-7s-id bg-premium-dark icon-gradient',
                    //     href: '/profile',
                    //     user_types: [ 1, 0 ]
                    // },
                ],
